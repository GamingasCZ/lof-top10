...
var jsStr = {
    ...
    "L_MOVE_D": ["Přesunout level níž", "Move level down"],
    "L_MOVE_U": ["Přesunout level výš", "Move level up"],
    ...
    "TAGS": [["Pomalý","Rychlý","Hodně objektů","2P","Hacknutý","Layout","Dekorace","1.9","Šílený","Unratelý","Nemožný","Shitpost","Minihra","List Demon","Jam","Challenge","Ztracený","Glowy","Remake","Gimmicky","Kontroverzní","Barevný","Moderní","Bossfight","Long","Nevydaný","dodělat!!!"],
             ["Slow", "Fast", "High Object Count","2P","Hacked","Layout","Decorated","1.9","Mindboggling","Unrated","Impossible","Shitpost","Minigame","List Demon","Jam","Challenge","Lost","Glowy","Remake","Gimmicky","Controversial","Colorful","Modern","Bossfight","Long","Unreleased","Hidden Gem"]],
