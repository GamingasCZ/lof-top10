...
var jsStr = {
    ...
    "TAGS": [["Pomalý","Rychlý","Hodně objektů","2P","Hacknutý","Layout","Dekorace","1.9","Šílený","Unratelý","Nemožný","Shitpost","Minihra","List Demon","Jam","Challenge","Ztracený","Přeglowovaný","Remake","Gimmicky","Kontroverzní","Barevný","Moderní","Bossfight","Dlouhý","Nevydaný","Nedoceněný"],
             ["Slow", "Fast", "High Object Count","2P","Hacked","Layout","Decorated","1.9","Mindboggling","Unrated","Impossible","Shitpost","Minigame","List Demon","Jam","Challenge","Lost","Glow Spam","Remake","Gimmicky","Controversial","Colorful","Modern","Bossfight","Long","Unreleased","Hidden Gem"]],
...
var parts = {
    ...
    "editor": [
        ...
        ["Role", "Role"],
        ["Část", "Part"],
        ["Editor popisku", "Description Editor"],
        ["Tučně", "Bold"],
        ["Kurzíva", "Italics"],
        ["Podtrhnout", "Underline"],
        ["Přeškrtnout", "Strikethrough"],
        ["Nadpis", "Title"],
        ["Odrážka", "List"],
        ["Náhled", "Preview"],
        ["Popis seznamu", "List Description"],
        ["Uložené levely", "Saved Levels"],
        ["        Hledat level...", "        Search levels..."],
        ["Nahrávání", "Upload"],
        ["Pro vytvoření seznamu se prosím přihlaš!", "Please login to make a list!"],
        ["Přihlásit se", "Log in"],
        ["Jméno seznamu", "List Name"],
        ["Popisek seznamu", "List Description"],
